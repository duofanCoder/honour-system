...
export const useTable = (
    ...
    const getTableList = async () => {
        try {
            ...
            Object.assign(
                state.totalParam,
                {query: JSON.stringify({...initParam, ...state.searchParam})},
            ...
            console.log("表格数据", toRaw(state.tableData))
    ...
    const updatedTotalParam = () => {
        ...
        Object.assign(state.totalParam, {query: JSON.stringify({...nowSearchParam})}, isPageable ? pageParam.value : {});
    };
    ...
    const handleCurrentChange = (val: number) => {
        ...
        console.log("我是分页参数", pageParam.value)
        getTableList();
    };
