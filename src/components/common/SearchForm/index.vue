<template>
  <div class="card table-search" v-if="columns.length">
    <el-form ref="formRef" :model="searchParam" size="default">
      <Grid ref="gridRef" :collapsed="collapsed" :gap="[20, 0]" :cols="searchCol">
        ...
        <GridItem suffix>
          <div class="operation">
            ...
            <el-button :icon="Delete" size="default" @click="reset">重置</el-button>
            <el-button
              v-if="showCollapse"
              type="primary"
              link
...
<script setup lang="ts" name="SearchForm">
  ...
  import Grid from '@/components/common/Grid/index.vue';
  import GridItem from '@/components/common/Grid/components/GridItem.vue';
